...
class DeliveryMethodsController {
  async getAll(req, res) {
    ...
    DeliveryMethodsModle.find({ name: { $regex: name } })
      .skip(skip)
      .limit(limit)
      .select(
        '_id name sortOrder description image hideFee rangesFeeType payOnDelivery calculationMethod baseFee ranges active'
      )
      .select(include)
      .then((result) => {
  ...
  async create(req, res) {
    ...
    const deliveryMethodsModle = new DeliveryMethodsModle({
      ..._.pick(req.body, [
        'name',
        'sortOrder',
        'image',
  ...
  async update(req, res) {
    ...
    DeliveryMethodsModle.findByIdAndUpdate(
      { _id: id },
      _.pick(req.body, [
        'name',
        'sortOrder',
